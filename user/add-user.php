...
$title = "Tambah User - Sunday Morning";
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <select name="jabatan" id="jabatan"
                                            class="form-select border-0 border border-bottom">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <textarea name="alamat" id="alamat" cols="30" rows="3" class="form-control"
                                            placeholder="domilisi" required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4 text-center px-5">
                                ...
                                <small class="text-secondary">Pilih foto PNG, JPG atau JPEG dengan ukuran maks 1
                                    MB</small>
