...
$title = "Ganti Password - Sunday Morning";
...
if ($msg == 'updated') {
    ...
    <i class="fa-solid fa-circle-check"></i> Ganti Password Anda Berhasil..
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}
if ($msg == 'err1') {
    $alert = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-circle-xmark"></i> Ganti Password Anda Gagal, Konfirmasi Password Tidak Sama..!
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}
if ($msg == 'err2') {
