<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color:#fd7e14;">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-5" href=""><img src="asset/image/smLogo.svg" width="30" height="30" alt="">
            Sunday Morning
        </a>
        <!-- Sidebar Toggle-->
        <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" style="margin-left: -220px"
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="<?= $main_url ?>sunmor/profile-sunmor.php">Profile SUNMOR</a>
                    </li>
                    <li>
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="<?= $main_url ?>asset/image/<?= $profile['foto'] ?>"
                                    class="img-fluid rounded-start" width="100%" alt="gambar username">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" readonly class="form-control border-0 bg-transparent"
                                                id="nama" value=": <?= $profile['nama'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" readonly class="form-control border-0 bg-transparent"
                                                id="jabatan" value=": <?= $profile['jabatan'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label for="alamat" class="col-sm-3 col-form-label pe-0">Alamat</label>
                                        <div class="col-sm-9">
                                            <textarea id="alamat" cols="30" rows="2"
